...
public class AdvancedStockPriceMonitor extends StockPriceMonitor implements
		Runnable {
	...
	protected int BIG_CHART_WIDTH = 500;
	protected int BIG_CHART_HEIGHT = 400;

	private static final Logger LOGGER = LoggerFactory
			.getLogger(AdvancedStockPriceMonitor.class);
	...
	public AdvancedStockPriceMonitor(String stockId, CountDownLatch stopLatch) {
		super(stockId);
	...
	protected String getSlowStochasticUrl() {
		String url = "http://charts.aastocks.com/servlet/Charts?fontsize=12"
				...
				+ getStockId() + ".HK" + "&period=6&type=5&logoStyle=1&";
		return url;
	}
	...
	protected BufferedImage prepareBigImg() {
		int width = CHART_WIDTH + BIG_CHART_WIDTH;
		...
		// draw big image
		g.drawImage(bigGraph, 0, 0, BIG_CHART_WIDTH, BIG_CHART_HEIGHT, null);
	...
	public static void main(String[] args) {
		...
		AdvancedStockPriceMonitor monitor = new AdvancedStockPriceMonitor("5",
				null);
		try {
