...
import net.favor.imagecapter.hibernate.reveng.bean.UpdateAttributeBean;
...
public class DaoGenerator {
	...
	private static final String OUTPUT_DIR = SRC_DIR + "net/favor/imagecapter/hibernate/reveng/dao/";
	...
	private static final String[] HINTS_CREATEDATE = new String[] { "CreateDate", "CreatedDate" };
